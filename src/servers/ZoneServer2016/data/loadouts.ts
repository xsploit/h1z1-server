...
export const characterJuggernautLoadout: LoadoutKit = [
  ...
  { item: Items.WEAPON_FROSTBITE },
  { item: Items.WEAPON_NAGAFENS_RAGE },
  { item: Items.WEAPON_REAPER },
  { item: Items.WEAPON_HEAVY_ASSAULT_MAGNUM },
  { item: Items.WEAPON_TOXIC_COMBATKNIFE },
  { item: Items.WEAPON_KATANA },
  { item: Items.WEAPON_HATCHET },
  { item: Items.WEAPON_BINOCULARS },
  { item: Items.AMMO_762, count: 600 },
  { item: Items.AMMO_12GA, count: 240 },
  { item: Items.AMMO_308, count: 200 },
  { item: Items.AMMO_44, count: 240 },
  { item: Items.GRENADE_HE, count: 20 },
  { item: Items.GRENADE_SMOKE, count: 10 },
  { item: Items.GRENADE_FLASH, count: 10 },
  { item: Items.FIRST_AID, count: 30 },
  { item: Items.BANDAGE_DRESSED, count: 50 },
  { item: Items.ADRENALINE_SHOT, count: 20 },
  { item: Items.PAINKILLERS, count: 20 },
  { item: Items.ANTIBIOTICS, count: 20 },
  { item: Items.GUN_REPAIR_KIT, count: 20 },
  { item: Items.REPAIR_BOX, count: 10 },
  { item: Items.WATER_PURE, count: 20 },
  { item: Items.CANNED_FOOD01, count: 20 },
  { item: Items.MAP },
  { item: Items.COMPASS }
];
